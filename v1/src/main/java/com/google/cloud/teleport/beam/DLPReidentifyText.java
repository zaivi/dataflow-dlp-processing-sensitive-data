...
public abstract class DLPReidentifyText
  ...
  @Nullable
  public abstract ValueProvider<String> getInspectTemplateName();

  /** @return Template name for data reidentification. */
  @Nullable
  public abstract ValueProvider<String> getReidentifyTemplateName();
  ...
  @Nullable
  public abstract ValueProvider<Character> getColumnDelimiter();
  ...
  public abstract ValueProvider<Integer> getBatchSizeBytes();
  ...
  public abstract static class Builder {
    ...
    public abstract Builder setInspectTemplateName(ValueProvider<String> inspectTemplateName);
     ...
     */
    public abstract Builder setReidentifyConfig(
        DeidentifyConfig reidentifyConfig);

    /** @param reidentifyTemplateName Template name for data deidentification. */
    public abstract Builder setReidentifyTemplateName(
        ValueProvider<String> reidentifyTemplateName);

    /**
     * @param batchSize Size of input elements batch to be sent to Cloud DLP service in one request.
     */
    public abstract Builder setBatchSizeBytes(ValueProvider<Integer> batchSize);
     ...
     */
    public abstract Builder setColumnDelimiter(ValueProvider<Character> delimiter);
    ...
    //   }
    //   if (dlpReidentifyText.getBatchSizeBytes().get().intValue() > DLP_PAYLOAD_LIMIT_BYTES) {
    //     throw new IllegalArgumentException(
    //         String.format(
...
//      requestBuilder = ReidentifyContentRequest.newBuilder().setParent(ProjectName.of(this.projectId.get()).toString());
      requestBuilder = ReidentifyContentRequest.newBuilder().setParent(projectId);
      if (inspectTemplateName != null) {
        requestBuilder.setInspectTemplateName(this.inspectTemplateName.toString());
      }
      ...
      if (reidentifyTemplateName != null) {
        requestBuilder.setReidentifyTemplateName(this.reidentifyTemplateName.toString());
      }

...
import com.google.cloud.teleport.templates.DLPTextToBigQueryBatch.TokenizePipelineOptions;
...
/**
 * The {@link DLPTextToBigQueryBatch} is a batching pipeline that reads CSV files from a
 ...
 * -Dexec.mainClass=com.google.cloud.teleport.templates.DLPTextToBigQueryBatch \
...
public class DLPTextToBigQueryBatch {

  public static final Logger LOG = LoggerFactory.getLogger(DLPTextToBigQueryBatch.class);
   ...
   * DLPTextToBigQueryBatch#run(TokenizePipelineOptions)} method to start the pipeline and
  ...
  public static PipelineResult run(TokenizePipelineOptions options) {
    ...
    PCollection<TableRow> bqDataMap =
            csvFiles
  ...
  public interface TokenizePipelineOptions extends DataflowPipelineOptions {
    ...
    @TemplateParameter.Text(
            ...
            example = "gs://your-bucket/your-files/*.csv.gz")
...
//    void setWorkerMachineType(String value);
    ...
    @TemplateParameter.NumberOfWorkerHarnessThreads(
            order = 9,
            description = "",
            helpText = "",
            example = "")
    ...
    @TemplateParameter.DirectNumWorkers(
            order = 9,
            description = "",
            helpText = "",
            example = "")
    ...
    @TemplateParameter.DataflowServiceOptions(
            order = 9,
            description = "",
            helpText = "",
            example = "")
    ...
    public void processElement(ProcessContext c, RestrictionTracker<OffsetRange, Long> tracker)
      ...
      for (long i = tracker.currentRestriction().getFrom(); tracker.tryClaim(i); ++i) {
        ...
        try (BufferedReader br = getReader(c.element().getValue())) {
          ...
          String message = String.format(template, tracker.currentRestriction().getFrom(), tracker.currentRestriction().getTo(), startOfLine,

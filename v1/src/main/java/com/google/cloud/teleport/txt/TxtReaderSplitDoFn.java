 ...
 */
package com.google.cloud.teleport.txt;

import com.google.cloud.teleport.templates.common.FileReader;
import com.google.cloud.teleport.json.JsonReaderSplitDoFn;
...
public class TxtReaderSplitDoFn extends DoFn<KV<String, ReadableFile>, KV<String, String>> {
  public static final Logger LOG = LoggerFactory.getLogger(TxtReaderSplitDoFn.class);
  private final Counter numberOfRowsRead = Metrics.counter(JsonReaderSplitDoFn.class, "numberOfRowsRead");
  private final Integer keyRange;
  private final String recordDelimiter;
  private final Integer splitSize;

  public TxtReaderSplitDoFn(Integer keyRange, String recordDelimiter, Integer splitSize) {

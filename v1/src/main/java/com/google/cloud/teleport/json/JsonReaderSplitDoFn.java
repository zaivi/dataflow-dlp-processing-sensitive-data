 ...
 */
package com.google.cloud.teleport.json;
...
public class JsonReaderSplitDoFn extends DoFn<KV<String, ReadableFile>, KV<String, String>> {
  public static final Logger LOG = LoggerFactory.getLogger(JsonReaderSplitDoFn.class);
  ...
  public JsonReaderSplitDoFn(Integer keyRange, String recordDelimiter, Integer splitSize) {

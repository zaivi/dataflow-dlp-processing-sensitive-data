...
final class AutoValue_DatastoreConverters_WriteEntities extends DatastoreConverters.WriteEntities {
  ...
  static final class Builder extends DatastoreConverters.WriteEntities.Builder {
    ...
    @Override
    public DatastoreConverters.WriteEntities.Builder setHintNumWorkers(ValueProvider<Integer> hintNumWorkers) {
    ...
    @Override
    public DatastoreConverters.WriteEntities.Builder setThrottleRampup(Boolean throttleRampup) {

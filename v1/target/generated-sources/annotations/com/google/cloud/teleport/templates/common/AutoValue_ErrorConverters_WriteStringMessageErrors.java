...
final class AutoValue_ErrorConverters_WriteStringMessageErrors extends ErrorConverters.WriteStringMessageErrors {
  ...
  private AutoValue_ErrorConverters_WriteStringMessageErrors(
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ErrorConverters.WriteStringMessageErrors) {
      ErrorConverters.WriteStringMessageErrors that = (ErrorConverters.WriteStringMessageErrors) o;
  ...
  static final class Builder extends ErrorConverters.WriteStringMessageErrors.Builder {
    private ValueProvider<String> errorRecordsTable;
    private String errorRecordsTableSchema;
    Builder() {
    }
    @Override
    public ErrorConverters.WriteStringMessageErrors.Builder setErrorRecordsTable(ValueProvider<String> errorRecordsTable) {
    ...
    @Override
    public ErrorConverters.WriteStringMessageErrors.Builder setErrorRecordsTableSchema(String errorRecordsTableSchema) {
    ...
    public ErrorConverters.WriteStringMessageErrors build() {
      ...
      return new AutoValue_ErrorConverters_WriteStringMessageErrors(

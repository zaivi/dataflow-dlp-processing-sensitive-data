...
COPY plugins .
COPY metadata .
COPY v1/src/main/java/com/google/cloud/teleport/templates/DLPTextToBigQueryBatch.java /dataflow/template/v1/src/main/java/com/google/cloud/teleport/templates/

ENV FLEX_TEMPLATE_JAVA_MAIN_CLASS="com.google.cloud.teleport.templates.DLPTextToBigQueryBatch"
ENV FLEX_TEMPLATE_JAVA_CLASSPATH="${WORKDIR}/v1/src/main/java/com/google/cloud/teleport/templates/DLPTextToBigQueryBatch.java"

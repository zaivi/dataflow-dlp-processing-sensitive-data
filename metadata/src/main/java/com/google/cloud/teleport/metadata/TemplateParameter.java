...
public final class TemplateParameter {
  ...
  @Retention(RetentionPolicy.RUNTIME)
  @Target({ElementType.FIELD, ElementType.METHOD})
  public @interface LauncherMachineType {
    /** Order of appearance. */
    int order() default 999;
  ...
  @Retention(RetentionPolicy.RUNTIME)
  @Target({ElementType.FIELD, ElementType.METHOD})
  public @interface WorkerMachineType {
    /** Order of appearance. */
    int order() default 999;
  ...
  @Retention(RetentionPolicy.RUNTIME)
  @Target({ElementType.FIELD, ElementType.METHOD})
  public @interface NumberOfWorkerHarnessThreads {
    /** Order of appearance. */
    int order() default 999;
  ...
  @Retention(RetentionPolicy.RUNTIME)
  @Target({ElementType.FIELD, ElementType.METHOD})
  public @interface DirectNumWorkers {
    /** Order of appearance. */
    int order() default 999;
  ...
  @Retention(RetentionPolicy.RUNTIME)
  @Target({ElementType.FIELD, ElementType.METHOD})
  public @interface DataflowServiceOptions {
    /** Order of appearance. */
    int order() default 999;
